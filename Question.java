...
public class Question {
    ...
    // Use a specific Quiz ID to group questions (Simplified for this example)
    private Long quizId; 

    public Question() {}

    public Question(String content, String option1, String option2, String option3, String option4, String answer, Long quizId) {
